...
function getbutton(){
	if(localStorage.getItem("xd")==null){
		var c=localStorage.getItem('scvalue');
		document.getElementById("xd").innerHTML="Twoj maksymalny wynik kiedykolwiek to: " +c;
	}
	
	else{
		document.getElementById("xd").innerHTML="Chociaz zagraj..";
	}
